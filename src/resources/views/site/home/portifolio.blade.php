 <section class="portfolio-section">
     <div class="auto-container">
         <div class="sec-title text-center">
             <div class="divider"><img src="{{ asset('davilla/images/portifolio/portfolio-1.png') }}" alt=""></div>
             <h2>Our Creations</h2>
         </div>
         ...
         <div class="row">
             ...
             <div class="portfolio-block col-lg-3 col-md-6 col-sm-12">
                 <div class="inner-box">
                     <div class="image-box">
                         <figure class="image"><img src="{{ asset('davilla/images/portifolio/portfolio-1.png') }}" alt=""></figure>
                     </div>
                     <div class="portfolio-hover">
                         ...
                         <a href="{{ asset("davilla/images/produto/$linha->slug_produto.png") }}" class="lightbox-image link" data-fancybox="portifolio"></a>
