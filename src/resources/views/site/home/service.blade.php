   ...
   <section class="services-section" style="background-image: url('{{ $recipes }}');">
                ...
                <div class="service-block">
                    <div class="inner-box">
                        <div class="image-box">
                            ...
                            <!-- cake img -->
                            <figure class="image"><img src="{{ asset("davilla/images/services-$linha->id_categoria.png") }}" alt=""></figure>
                        </div>
